...
},{"buffer":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"Customer.js":[function(require,module,exports) {
"use strict";
...
var setColor = function setColor(value) {
  ...
  if (value > 7.5) {
    return "rgba(76, 175, 80, ".concat(opacity, ")");
  } else if (value < 3.5) {
    return "rgba(244, 67, 54, ".concat(opacity, ")");
  } else {
    return "rgba(255, 193, 7, ".concat(opacity, ")");
  }
};
...
function () {
  function Customer(_ref) {
    var paying = _ref.paying,
        health = _ref.health,
        daysToRenewal = _ref.daysToRenewal,
        daysLastContacted = _ref.daysLastContacted;
...
//# sourceMappingURL=/planhat-exercise.e31bb0bc.js.map